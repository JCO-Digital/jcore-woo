...
function register_blocks_metadata(): void {
	$base_path = trailingslashit( JCORE_WOO_PLUGIN_PATH ) . 'blocks/build';
	$manifest  = trailingslashit( JCORE_WOO_PLUGIN_PATH ) . 'blocks/build/blocks-manifest.php';
...
function register_blocks(): void {
	...
	foreach ( $blocks as $block ) {
		$block_file = join_path( JCORE_WOO_PLUGIN_PATH, 'blocks/build', $block, 'block.json' );
